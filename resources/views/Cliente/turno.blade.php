...
<body>
	...
	<div class="container-fluid tm-main">
		<div class="row tm-main-row">
			...
			<!-- Sidebar -->
			<div id="tmSideBar" class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-20 sidebar">
				...
				<div class="inner">
					<nav id="tmMainNav" class="tm-main-nav">
						<ul>
							<li>
								<a class="scrolly active " >
									<i class="tm-nav-fa-icon"> 3 </i>
									<span>000001</span>
								</a>
							</li>
							<li>
							<a class="scrolly active " >
									<i class="tm-nav-fa-icon"> 2 </i>
									<span>000002</span>
								</a>
							</li>
							<li>
							<a class="scrolly active " >
									<i class="tm-nav-fa-icon"> 1 </i>
									<span>000003</span>
								</a>
							</li>
							<li>
			...
			<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content col-80">
